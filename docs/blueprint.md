...
- Primary color: Sage green (#98DDCA) to evoke nature and tranquility.
- Background color: Off-white (#F5F5F5) for a clean and minimalist look.
- Accent color: Terracotta (#E07A5F) for highlights and CTAs.
- Body and headline font: 'PT Sans' (sans-serif) for a modern yet friendly feel.
- Lucide React icons for a consistent and modern look.
- Card-based layout for tour listings and dashboard sections, inspired by 'bersukaria.com'.
- Subtle loading spinners and toast notifications for user feedback.